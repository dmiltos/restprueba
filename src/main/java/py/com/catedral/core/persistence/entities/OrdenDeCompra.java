...
@NamedNativeQueries({
	@NamedNativeQuery(
	name = "Producto.callObtenerOrdenesCompraSP",
//	query = "begin GET_SINGLE_PRODUCT_INFO(?, ?, ?, ?, ?); end;")
	query = "{call PA_OBTENER_ORDENES_COMPRA_PENDIENTES(?, :p_cod_barra, :p_cod_inventario, :p_fec_proceso, :p_ind_manual, :p_estado, :p_cantidad, :p_lote, :p_vencimiento, :p_ind_tipo_evento)}", 
		resultClass = OrdenDeCompra.class, hints = {
